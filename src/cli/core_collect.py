...
@click.option("--delay", type=float, default=1.0, help="Delay between API calls (S2 has strict limits)")
@click.option("--parallel", "-p", type=int, default=1, help="Concurrent requests (keep low for S2)")
...
def enrich_s2(
    ...
    Requires S2_API_KEY env var for higher rate limits.
