...
Extraction pipeline:
1. Regex: acronym extraction from title/abstract
2. KeyBERT: semantic keyword extraction from abstract (optional)
"""
...
class KeywordExtractor:
    """Regex + KeyBERT keyword extractor for academic papers.
